import {
  ...
  export default function EditPhysioExercise() {
    const router = useRouter();
    const { EditPhysioExercises } = useLocalSearchParams(); // Fetch the id from route params
    ...
    const fetchPhysioExercise = async () => {
      setLoading(true);
      try {
        const docRef = doc(db, "physioExercises", EditPhysioExercises);
    ...
    const onUpdateTip = async () => {
      ...
      try {
        ...
        ToastAndroid.show(
          "Physio Exercise Updated Successfully",
          ToastAndroid.LONG
        );
          ...
          {loading ? (
            ...
            <>
              ...
              >
                ...
                >
                  {loading ? "Updating..." : "Update Physio Exercise"}
                </Text>
              </TouchableOpacity>
            </>
          )}
